...
public final class Instruction {
    ...
    public static final String ASK_QUESTION = """
            ...
            아이에게 인사하고, 질문을 위한 빌드업을 하면서 자연스럽게 질문을 해 줄래? (관리자 지침: Audio type으로 반환)''
            질문: %s
            """;

    public static final String GREETING = """
            ''안녕! 난 관리자야. 지금 아이가 근처에 있어. 지금 시간은 %s이야. 시간에 맞는 인사를 아이에게 해 줄래? (관리자지침: Audio type으로 반환)''
            """;

    public static final String START_CONVERSATION = """
            ''안녕! 난 관리자야. 지금 아이가 대화를 시작하고 싶어해! 아이에게 어떤 일이 있는지 물어봐줄래? (관리자지침: Audio type으로 반환)\s
